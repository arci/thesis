...
\subfloat[EMPLOYEE]{
	...
	\hline\hline
	\textbf{TODO} & Fabio & 123  & \textbf{TODO} \\ \hline
	\end{tabular}
	\hspace{0.5cm}
}
...
\subfloat[PHONE]{
	...
	\textbf{PHONE\textunderscore ID} & \textbf{NUMBER}\\ 
	\hline\hline
	\textbf{DEFAULT\textunderscore TODO} & 123456789 \\ \hline
	\end{tabular}
	\hspace{0.5cm}
}
\\
\subfloat[EMPLOYEE]{
	...
	\textbf{EMPLOYEE\textunderscore ID} & \textbf{NAME} & \textbf{SALARY} & \textbf{PHONE\textunderscore ID}\\ 
	\hline\hline
	\textbf{DEFAULT\textunderscore TODO} & Fabio & 123  & \textbf{DEFAULT\textunderscore TODO} \\ \hline
	\end{tabular}
	\hspace{0.5cm}
}
