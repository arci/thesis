...
\usepackage{dblfnote}						% footnotes on two columns
...
% Kundera extension
%--------------------------------------------------------------------------------
\chapter{Kundera clients development}
\label{chap:kundera}
\input{content/kundera-clients-development}
...
\chapter{Hegira Generator}
\label{app:hegira-generator}
\input{content/hegira-generator}
